...
public class VerificationOrchestrator {
    ...
    public UUID addJob(Optional<String> projectId, IFbCFormula formula, FilesController filesController) throws IOException {
    ...
    public IFbCFormula getVerificationResult(UUID jobId) {
